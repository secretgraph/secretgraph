...
### internal handle result

The result can have following fields and the raw decrypted json field is added as "value":
...
why: seperate actions on contents with different concerns.
