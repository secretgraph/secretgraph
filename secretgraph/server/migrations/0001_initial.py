# Generated by Django 3.1 on 2020-08-15 19:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updateid', models.UUIDField(blank=True, default=uuid.uuid4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='secretgraph.content')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(editable=False, primary_key=True, serialize=False)),
                ('group', models.CharField(blank=True, default='', help_text='ContentReference group: references are clustered in groups. They are used to signal different functions of the connection', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.CharField(blank=True, default='', help_text='ContentAction group: ContentActions are clustered in groups. They are used to signal different functions of the connection', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contentAction', models.OneToOneField(blank=True, db_column='content_action', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='action', to='secretgraph.contentaction')),
            ],
        ),
