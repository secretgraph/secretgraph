...
export const SECRETGRAPH = Namespace("https://secretgraph.net/static/schemes/secretgraph/secretgraph#");
export const CLUSTER = Namespace("https://secretgraph.net/static/schemes/secretgraph/cluster#");
