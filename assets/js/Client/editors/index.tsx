...
export const elements = new Map([
  ...
  ['Text', { label: gettext('Text'), component: React.lazy(() => import("./file")) }],
  ['Contact', { label: gettext('Contact'), component: React.lazy(() => import("./contact")) }],
  ['PublicKey', { label: gettext('Keys'), component: React.lazy(() => import("./keys")) }],
  ['Postbox', { label: gettext('Postbox'), component: React.lazy(() => import("./postbox")) }],
