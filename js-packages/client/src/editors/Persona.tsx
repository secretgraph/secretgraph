...
const EditPersona = ({ viewOnly }: { viewOnly?: boolean }) => {
    ...
    return <InnerPersona {...data} disabled={loading} viewOnly={viewOnly} />
}
const CreatePersona = () => {
    ...
    return <InnerPersona {...data} disabled={loading} />
}
const ViewPersona = () => {
    return <EditPersona viewOnly />
}

export default function PersonaComponent() {
    const { mainCtx, updateMainCtx } = React.useContext(Contexts.Main)
    return (
        <DecisionFrame
            mainCtx={mainCtx}
